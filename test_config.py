...
def test_config():
    ...
    if "MARS_SHARES_PORT" in os.environ:
        ...
        if DEFAULT_SHARES_PORT == expected:
            print(f"   ✓ MARS_SHARES_PORT env var correctly overrides: {DEFAULT_SHARES_PORT}")
        else:
            print(f"   ✗ MARS_SHARES_PORT mismatch: got {DEFAULT_SHARES_PORT}, expected {expected}")
    ...
    if "MARS_USE_SHARES" in os.environ:
        ...
        if USE_SHARES == expected:
            ...
            print(f"   ✗ MARS_USE_SHARES mismatch: got {USE_SHARES}, expected {expected}")
