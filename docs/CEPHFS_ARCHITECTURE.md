...
1. **Wait for acknowledgment**: All replica OSDs must confirm write
1. **Update metadata**: Notify MDS that data is committed
...
1. **Temporary mitigation** (if storage team can't help immediately):
